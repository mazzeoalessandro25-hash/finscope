...
const INDEX_DATA = {
  ...
  /* ── FTSE 100 top 50 ── */
  ftse100: [
    {s:'SHEL.L',n:'Shell',sec:'Energy',mkt:'UK'},
    {s:'AZN.L',n:'AstraZeneca',sec:'Healthcare',mkt:'UK'},
    {s:'HSBA.L',n:'HSBC',sec:'Financial Services',mkt:'UK'},
    {s:'ULVR.L',n:'Unilever',sec:'Consumer Defensive',mkt:'UK'},
    {s:'BP.L',n:'BP',sec:'Energy',mkt:'UK'},
    {s:'RIO.L',n:'Rio Tinto',sec:'Basic Materials',mkt:'UK'},
    {s:'GSK.L',n:'GSK',sec:'Healthcare',mkt:'UK'},
    {s:'BATS.L',n:'British American Tobacco',sec:'Consumer Defensive',mkt:'UK'},
    {s:'REL.L',n:'RELX',sec:'Industrials',mkt:'UK'},
    {s:'DGE.L',n:'Diageo',sec:'Consumer Defensive',mkt:'UK'},
    {s:'NG.L',n:'National Grid',sec:'Utilities',mkt:'UK'},
    {s:'BHP.L',n:'BHP Group',sec:'Basic Materials',mkt:'UK'},
    {s:'GLEN.L',n:'Glencore',sec:'Basic Materials',mkt:'UK'},
    {s:'LSEG.L',n:'London Stock Exchange',sec:'Financial Services',mkt:'UK'},
    {s:'BA.L',n:'BAE Systems',sec:'Industrials',mkt:'UK'},
    {s:'LLOY.L',n:'Lloyds Banking',sec:'Financial Services',mkt:'UK'},
    {s:'BARC.L',n:'Barclays',sec:'Financial Services',mkt:'UK'},
    {s:'ABF.L',n:'Associated British Foods',sec:'Consumer Defensive',mkt:'UK'},
    {s:'PRU.L',n:'Prudential',sec:'Financial Services',mkt:'UK'},
    {s:'WPP.L',n:'WPP',sec:'Communication Services',mkt:'UK'},
    {s:'TSCO.L',n:'Tesco',sec:'Consumer Defensive',mkt:'UK'},
    {s:'IMB.L',n:'Imperial Brands',sec:'Consumer Defensive',mkt:'UK'},
    {s:'NWG.L',n:'NatWest Group',sec:'Financial Services',mkt:'UK'},
    {s:'CRH.L',n:'CRH',sec:'Basic Materials',mkt:'UK'},
    {s:'EXPN.L',n:'Experian',sec:'Industrials',mkt:'UK'},
    {s:'JD.L',n:'JD Sports',sec:'Consumer Cyclical',mkt:'UK'},
    {s:'VOD.L',n:'Vodafone',sec:'Communication Services',mkt:'UK'},
    {s:'MNDI.L',n:'Mondi',sec:'Basic Materials',mkt:'UK'},
    {s:'SSE.L',n:'SSE',sec:'Utilities',mkt:'UK'},
    {s:'CNA.L',n:'Centrica',sec:'Utilities',mkt:'UK'},
    {s:'ADM.L',n:'Admiral Group',sec:'Financial Services',mkt:'UK'},
    {s:'SBRY.L',n:'Sainsbury',sec:'Consumer Defensive',mkt:'UK'},
    {s:'SN.L',n:'Smith & Nephew',sec:'Healthcare',mkt:'UK'},
    {s:'STJ.L',n:'St. James Place',sec:'Financial Services',mkt:'UK'},
    {s:'FRES.L',n:'Fresnillo',sec:'Basic Materials',mkt:'UK'},
    {s:'LAND.L',n:'Land Securities',sec:'Real Estate',mkt:'UK'},
    {s:'PSN.L',n:'Persimmon',sec:'Consumer Cyclical',mkt:'UK'},
    {s:'SGE.L',n:'Sage Group',sec:'Technology',mkt:'UK'},
    {s:'CPG.L',n:'Compass Group',sec:'Consumer Cyclical',mkt:'UK'},
    {s:'SMDS.L',n:'DS Smith',sec:'Basic Materials',mkt:'UK'},
    {s:'INF.L',n:'Informa',sec:'Communication Services',mkt:'UK'},
    {s:'RKT.L',n:'Reckitt',sec:'Consumer Defensive',mkt:'UK'},
    {s:'KGF.L',n:'Kingfisher',sec:'Consumer Cyclical',mkt:'UK'},
    {s:'SVT.L',n:'Severn Trent',sec:'Utilities',mkt:'UK'},
    {s:'OCDO.L',n:'Ocado',sec:'Consumer Defensive',mkt:'UK'},
    {s:'UU.L',n:'United Utilities',sec:'Utilities',mkt:'UK'},
    {s:'BWY.L',n:'Bellway',sec:'Consumer Cyclical',mkt:'UK'},
    {s:'III.L',n:'3i Group',sec:'Financial Services',mkt:'UK'},
    {s:'HWDN.L',n:'Howden Joinery',sec:'Consumer Cyclical',mkt:'UK'},
  ],
